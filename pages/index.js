        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-body md:gap-24">
          ...
          <div className="col-span-1 pt-4 md:pt-16">
            <div className="pl-2 pr-2 md:pl-0 md:pr-0">
              ...
              <p className="text-xl">“It just doesn’t feel like <em>us</em>.”</p>

              <p>Sound familliar?</p>
              
              <p>Every member of a startup or product team interacts with and shapes the product’s brand every day. And yet, while many of us have an instinctive understanding of the <strong>Brand Thing</strong>, we don’t have a full conceptual model or the language to anchor that understanding around.</p>
              
              <p>That leaves us with many different interpretations of what brand is, and so we approach conversations from different vantage points involving a lot of subjective opinion, which often leaves us vaguely confused and dissatisfied when the conversation is over.</p>
              
              <p>And though many startups and product teams have some of the Brand Thing figured out, they’re often missing the bits that everything else is built around, leaving us grasping for something that’s not there.</p>

              <p>This is a primer for startups and product teams that want to get a better understanding of the Brand Thing.</p>
              
              <p>This primer will make it easier to:</p>
              
              <ul>
                <li><strong>Have conversations</strong> about brand with a shared vocabulary and from a shared conceptual understanding of what brand is.</li>
                <li><strong>Make better decisions faster</strong> about not just the brand, but the product itself.</li>
              ...
              <p>Once the brand strategy and identity is figured out, brand expression is where all those abstract bits become concrete and tangible.</p>
              ...
              <p>I invented a bunch of questions and answered them. As I get more real questions from real readers, I’ll answer them.</p>
          ...
          <div className="col-span-1">
            ...
            <li><a href="#introduction">Introduction</a></li>
              <li>
                <a href="#the-things-you-need-to-know">The things you need to know</a>
                <ul>
                  <li><a href="#brand">Brand</a></li>
                  <li><a href="#brand-platform">Brand platform</a></li>
                  <li>
                  ...
                  <li><a href="#brand-stewardship">Brand stewardship</a></li>
                </ul>
              </li>
              <li><a href="#i-have-questions">I have questions</a></li>
            </ul>  
          </div>
        </div>
      </main>
